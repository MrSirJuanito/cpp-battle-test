...
namespace sw {
	class HunterUnit : public BaseUnit, public HealthUnit, public MarchUnit, public AttackCloseUnit {
	public:
		HunterUnit(IGameWorld& _world, uint32_t _id, uint32_t _x, uint32_t _y, uint32_t _health, uint32_t _strength) :
